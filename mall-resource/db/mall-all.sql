create database IF NOT EXISTS `mall_auth` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_biz` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_leaf` default character set utf8 collate utf8_general_ci;
...
-- ----------------------------
INSERT INTO `leaf_alloc` VALUES ('mall-auth-account', 112000, 100, '2021-07-01 14:16:40', 'mall-multishop数据库中auth_account这张表的uid', 10);
INSERT INTO `leaf_alloc` VALUES ('mall-multishop-user', 110400, 100, '2021-07-01 11:10:32', 'mall-multishop数据库中shop_user这张表的id', 10);
INSERT INTO `leaf_alloc` VALUES ('mall-order', 1568693084, 100, '2021-07-05 15:25:19', '订单id', 10);
INSERT INTO `leaf_alloc` VALUES ('mall-pay', 564994845, 100, '2021-07-05 15:14:40', '支付单号', 10);
INSERT INTO `leaf_alloc` VALUES ('mall-platform-user', 101600, 100, '2021-07-03 13:13:54', 'mall-platform数据库中sys_user这张表的id', 10);
INSERT INTO `leaf_alloc` VALUES ('mall-user', 106600, 100, '2021-07-01 11:22:26', 'mall-user数据库中user这张表的id', 10);


create database IF NOT EXISTS `mall_multishop` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_nacos` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_order` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_payment` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_platform` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_product` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_rbac` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_seata` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `mall_user` default character set utf8 collate utf8_general_ci;
