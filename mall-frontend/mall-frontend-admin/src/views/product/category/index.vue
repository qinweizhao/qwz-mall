...
<script>
import { listMenu, getMenu, delMenu, addMenu, updateMenu } from "@/api/product/category";
  ...
  methods: {
    ...
    getList() {
      ...
      listMenu(this.queryParams).then(response => {
        this.menuList = this.handleTree(response.data, "catId");
        this.loading = false;
      });
    },
    /** 转换分类数据结构 */
