    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['order:advert:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['order:advert:export']"
        >导出</el-button>
      </el-col>
...
<script>
  import {addAdvert, delAdvert, getAdvert, listAdvert, updateAdvert} from "@/api/activity/advert";
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('order/advert/export', {
        ...this.queryParams
