...
export function categoryPage(pageParam) {
  return request({
    url: '/mall_product/admin/category/platform_categories',
    method: 'get',
    params: {}
  })
}
...
export function shopCategoryPage(pageParam) {
  return request({
    url: '/mall_product/admin/category/shop_categories',
    method: 'get',
    params: {}
  })
}
...
export function getShopAttrs() {
  return request({
    url: '/mall_product/admin/attr/get_shop_attrs',
    method: 'get',
    params: {}
  })
}
...
export function enableOrDisable(data) {
  return request({
    url: '/mall_product/admin/category/category_enable_or_disable',
    method: 'put',
    data
  })
}
