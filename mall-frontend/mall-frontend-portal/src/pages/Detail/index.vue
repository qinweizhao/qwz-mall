      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input type="number" autocomplete="off" class="itxt" v-model.number="skuNum" @change="changeSkuNum">
                <button href="javascript:" class="plus" @click="skuNum++">+</button>
                <button href="javascript:" class="mins" @click="skuNum>1 ? skuNum--:skuNum=1">-</button>
              </div>
              <div class="add">
                <a style="cursor: pointer" @click="addShopCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...mapGetters('detail',['categoryView','skuInfo','spuSaleAttrList','price','valuesSkuJson']),
      skuImageList(){
        return this.skuInfo.skuImageList || []
      },
    },
    methods:{
      //售卖属性的排他性(只能选一个) current代表当前选择 arr代表当前售卖属性的数组
