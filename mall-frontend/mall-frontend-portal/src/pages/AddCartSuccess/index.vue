    ...
    <div class="cart-complete">
      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info" style="top: -20px">
            <p class="title">{{skuInfo.skuName}}</p>
            <p class="attr" v-for="(item,index) in spuSaleAttrList" >
              <span v-for="(attr,index) in item.spuSaleAttrValueList" v-if="attr.isChecked=='1'">{{item.saleAttrName}}：{{ item.spuSaleAttrValueList[index].saleAttrValueName }}</span></p>
